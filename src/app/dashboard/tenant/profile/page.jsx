        ...
        <div className="p-6">
          ...
          {editing ? (
            <div className="space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2.5 border border-line text-sm font-medium rounded-sm hover:bg-moss/10"
                >
                  Cancel
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 mt-2 p-4 border border-line rounded-sm bg-moss/5 text-sm text-muted">
                Keep your profile updated to improve trust with property owners.
              </div>
